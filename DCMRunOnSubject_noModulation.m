function DCMRunOnSubject_noModulation(subjectPath, runName)

    DCMCreateModels_noModulation(subjectPath,runName)

    dcmPath = fullfile(subjectPath, 'DCM');
    
    designDCMsDirs = dir(fullfile(dcmPath, runName, 'DCM_design_no_mod*.mat'));
    ...
    for i = 1:numel(designDCMs)
        ...
        save(fullfile(dcmPath, runName,['DCM_estimated_no_mod',num2str(i,'%02d'),'.mat']),'DCM');
    end
